export default function Footer() {
  return (
    <footer className="absolute bottom-0 h-fit w-full">
      <div className="relative flex items-center justify-between border-t-2 border-darkmode_light bg-darkmode_dark p-4 text-[10px] text-gray">
        <p>
          &copy; {new Date().getFullYear()} Watchdawg Services. <br />
          All rights reserved.
        </p>
        <a
          href="https://discord.gg/Sp7UM7DhN4"

...
func defaultAskOptions() *AskOptions {
	return &AskOptions{
		...
		PromptConfig: PromptConfig{PageSize: 7, HelpInput: "?", SuggestInput: "tab", Icons: IconSet{Error: Icon{Text: "X", Format: "red"}, Help: Icon{Text: "?", Format: "cyan"}, Question: Icon{Text: "?", Format: "cyan"}, MarkedOption: Icon{Text: "[x]", Format: "green"}, UnmarkedOption: Icon{Text: "[ ]", Format: "default+hb"}, SelectFocus: Icon{Text: ">", Format: "cyan+b"}}, Filter: func(filter string, value string, index int) (include bool) {
			filter = strings.ToLower(filter)
			return strings.Contains(strings.ToLower(value), filter)
		}, KeepFilter: false, ShowCursor: false, RemoveSelectAll: false, RemoveSelectNone: false, HideCharacter: '*'},
	}
}
